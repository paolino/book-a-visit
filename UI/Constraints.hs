...
type IconsU m u a = (HasIcons m (Zone u a), HasIcons m (Place (Opponent u) a))
type Icons m a = (HasIcons m (Zone Giver a), HasIcons m (Zone Taker a), HasIcons m (Place Taker a), HasIcons m (Place Giver a))
